...
const eai_model_info_t EAI_MODELS[] = {
    ...
    /* ============================================================ */
    {
        ...
        .train_ram_mb = 240, .lora_supported = true, .lora_adapter_mb = 10
    },
    ...
    /* ============================================================ */
    {
        ...
        .train_ram_mb = 600, .lora_supported = true, .lora_adapter_mb = 15
    },
    {
        .name = "qwen2-0.5b-q4",
        .family = "Qwen2",
        ...
        .train_ram_mb = 360, .lora_supported = true, .lora_adapter_mb = 8
    },
    {
        .name = "smollm-360m-q5",
        .family = "SmolLM",
        ...
        .train_ram_mb = 300, .lora_supported = true, .lora_adapter_mb = 5
    },
    ...
    /* ============================================================ */
    {
        ...
        .train_ram_mb = 1800, .lora_supported = true, .lora_adapter_mb = 30
    },
    {
        .name = "gemma-2b-q4",
        .family = "Gemma",
        ...
        .train_ram_mb = 2400, .lora_supported = true, .lora_adapter_mb = 25
    },
    {
        .name = "phi-mini-q4",
        .family = "Phi",
        ...
        .train_ram_mb = 4096, .lora_supported = true, .lora_adapter_mb = 45
    },
    {
        .name = "qwen2-1.5b-q4",
        .family = "Qwen2",
        ...
        .train_ram_mb = 1500, .lora_supported = true, .lora_adapter_mb = 20
    },
    ...
    /* ============================================================ */
    {
        ...
        .train_ram_mb = 5000, .lora_supported = true, .lora_adapter_mb = 40
    },
    {
        .name = "mistral-7b-q3k",
        .family = "Mistral",
        ...
        .train_ram_mb = 7000, .lora_supported = true, .lora_adapter_mb = 80
    },
    ...
    /* ============================================================ */
    {
        ...
        .train_ram_mb = 12000, .lora_supported = true, .lora_adapter_mb = 100
    },
    {
        .name = "qwen2.5-7b-q4",
        .family = "Qwen2.5",
        ...
        .train_ram_mb = 11000, .lora_supported = true, .lora_adapter_mb = 90
    },
};
...
void eai_model_list(void) {
    ...
    fprintf(stderr, "%-25s %-8s %-6s %-6s %-8s %-6s %-5s %s\n",
            "Model", "Family", "Params", "RAM", "Storage", "Tier", "LoRA", "Hardware");
    fprintf(stderr, "%-25s %-8s %-6s %-6s %-8s %-6s %-5s %s\n",
            "-------------------------", "--------", "------", "------",
            "--------", "------", "-----", "--------------------");
    for (int i = 0; i < EAI_MODEL_COUNT; i++) {
        const eai_model_info_t *m = &EAI_MODELS[i];
        fprintf(stderr, "%-25s %-8s %4uM %4uMB %5uMB %-6s %-5s %s\n",
                m->name, m->family, m->param_count_m, m->ram_mb,
                m->storage_mb, tier_str(m->tier),
