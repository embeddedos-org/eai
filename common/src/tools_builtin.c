...
static eai_status_t eai_tool_mqtt_publish_register(eai_tool_registry_t *reg)
{
    eai_tool_t tool = {0};
...
static eai_status_t eai_tool_device_read_sensor_register(eai_tool_registry_t *reg)
{
    eai_tool_t tool = {0};
...
static eai_status_t eai_tool_http_get_register(eai_tool_registry_t *reg)
{
    eai_tool_t tool = {0};
